...
import type { UmkmKategori } from "@/types";
...
export default function UmkmPage() {
  ...
  const filtered = aktif === "semua"
    ? UMKM_MOCK
    : UMKM_MOCK.filter((u) => u.kategori === aktif);
              ...
              <div key={u.id} className="card-base card-hover">
                ...
                <div style={{ padding: "20px" }}>
                  <span style={{
                    ...
                    borderRadius: "9999px", display: "inline-block", marginBottom: "10px",
                  ...
                  <h2 style={{
                    ...
                    fontSize: "1rem", color: "var(--color-ocean-900)", marginBottom: "4px",
                  }}>
                    {u.name}
                  </h2>
                  <div style={{ fontSize: "0.78rem", color: "var(--color-ocean-500)", marginBottom: "10px" }}>
                    👤 {u.owner}
                  </div>
                  <p style={{
