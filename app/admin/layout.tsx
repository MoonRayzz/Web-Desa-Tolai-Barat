...
function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      {/* Sidebar */}
      <aside style={{
        width: "240px", background: "var(--color-ocean-900)",
          ...
          {NAV.map((n) => {
            ...
            return (
              <Link key={n.href} href={n.href} style={{
                ...
                borderLeft: active ? "2px solid var(--color-ocean-400)" : "2px solid transparent",
        ...
        <div style={{
          ...
          <div style={{ fontSize: "0.72rem", color: "rgba(255,255,255,0.4)", marginBottom: "8px" }}>
            {user.email}
          </div>
      ...
      {/* Main */}
      <main style={{
        flex: 1, background: "var(--color-ocean-50)",
